  ...
  return (
    ...
    >
      <div className="flex max-h-[92vh] w-full max-w-xl flex-col rounded-t-3xl border-t border-line bg-surface p-5 sm:rounded-3xl sm:border">
        ...
        {/* Bibliothèque : en-tête + toggle filtres. La recherche reste toujours visible
            (native) ; seule la LISTE de résultats se replie/déroule (géré dans
            ExerciseMultiSelect, via son bouton interne "Voir la bibliothèque"). */}
                          ...
                          {s.exercises.map((ex) => {
                            ...
                            return (
                              <div key={ex.uid} className="px-3 py-2">
                                {/* Ligne 1 : nom · RPE client ou Raté */}
                                ...
                                {/* Ligne 2 : prescription · poids réalisé */}
                                {(prescription || (ex.weightClient ?? 0) > 0) && (
